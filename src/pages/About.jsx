          ...
          <div className="grid md:grid-cols-12 gap-12 items-center">
            ...
            <div className="md:col-span-5 flex justify-center md:justify-start">
              ...
              `}>
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-blue-400 via-purple-400 to-pink-400 rounded-3xl transform rotate-3 transition-all duration-500 group-hover:rotate-6 group-hover:scale-105 opacity-20 blur-sm"></div>
                
                {/* Secondary background for depth */}
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-purple-500 rounded-3xl transform -rotate-2 transition-all duration-500 group-hover:-rotate-4 group-hover:scale-102 opacity-30"></div>
                ...
                <div className="relative bg-gray-800 p-6 rounded-3xl border border-gray-700 shadow-2xl transition-all duration-500 group-hover:shadow-3xl group-hover:border-blue-400/50">
                  ...
                  {/* Subtle inner glow */}
                  <div className="absolute inset-6 rounded-2xl bg-gradient-to-br from-blue-400/10 to-purple-400/10 pointer-events-none transition-opacity duration-500 group-hover:opacity-20"></div>
                </div>
